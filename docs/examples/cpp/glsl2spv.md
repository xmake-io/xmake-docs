...
<FileExplorer rootFilesDir="examples/utils/glsl2spv/glsl" />

## HLSL to SPIR-V

We can also use `utils.hlsl2spv` rule to compile HLSL to SPIR-V.

<FileExplorer rootFilesDir="examples/utils/glsl2spv/hlsl" />
...
<FileExplorer rootFilesDir="examples/utils/glsl2spv/glsl_bin2obj" />
