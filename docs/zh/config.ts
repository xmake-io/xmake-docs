...
function descriptionApiGuide(): DefaultTheme.SidebarItem[] {
  return [
    ...
    { text: '全局接口', link: '/global_interfaces' },
    { text: '辅助接口', link: '/helper_interfaces' },
    { text: '工程目标', link: '/project_target' },
    { text: '配置选项', link: '/configuration_option' },
    { text: '插件任务', link: '/plugin_task' },
    { text: '自定义规则', link: '/custom_rule' },
    { text: '自定义工具链', link: '/custom_toolchain' },
    { text: '包依赖管理', link: '/package_dependencies' },
    { text: '内置变量', link: '/builtin_variables' },
    { text: 'XPack 打包', link: '/xpack' }
  ]
}
...
function scriptsApiGuide(): DefaultTheme.SidebarItem[] {
  return [
    ...
    { text: '内置模块', link: '/builtin_modules' },
    { text: '扩展模块', link: '/extension_modules' },
