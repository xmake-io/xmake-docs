...
| [Sam Huang](https://github.com/celonymire) | [Avatar Cam](https://ko-fi.com/skazshop). We do live interactive avatars with prebuilt and commissioned models for everyone. | XMake deserves more recognition for simplifying the package management and build process of a CMake project. It is the closest tool I have seen that brings the cohesiveness of Rust's Cargo for a unified ecosystem. |
